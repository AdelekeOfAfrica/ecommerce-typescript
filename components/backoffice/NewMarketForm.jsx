  ...
  return (
    ...
    " >
      <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
        ...
        <SelectInput  multiple={true}  label="Select categories" name="categoryIds" register={register} options={categories}   
          errors={errors} className="w-full" />


       {/* always remember to configure your image endpoint */}
       <ImageInput imageUrl={imageUrl} setImageUrl={setImageUrl} endpoint="marketLogoUploader"  label="Market Logo"/>
